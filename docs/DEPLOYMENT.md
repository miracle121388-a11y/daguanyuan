...
[在线推演与游园](https://daguanyuan-rumeng.zeabur.app/)。当前园林为 **spatial-garden-20260918-r22**（建筑 r18、府邸围合与街坊 r22、地表 r21），梦绢功能仍为 **honglou-silk-20260917-v6**。源码提交 f44ac67 已同步 main；原 California 服务部署 **6aacb78c0f50de6ff52c2a78**，2026-09-18T04:03:13.789Z 完成构建，状态 **RUNNING**。当前记录：reports/acceptance/r22-deployment/release.json；r21 及更早记录保留为历史。
