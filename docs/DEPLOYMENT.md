...
[在线推演与游园](https://daguanyuan-rumeng.zeabur.app/)。故事推演展示已于 2026-09-22 更新，源码提交 3c7a6d8 已同步 main：四位原创彩绘人物、行动与持物、临场镜头、问安茶叙入口和手机布局。人物版本 **garden-players-20260921-v1**；园景仍为 **spatial-garden-20260918-r22**，梦绢仍为 **honglou-silk-20260917-v6**。最终部署 **6ab154c1c71834649e10f7a8** 于 2026-09-21T16:03:46.911Z 完成，状态 **RUNNING**。本轮记录：reports/acceptance/story-experience-20260921/deployment/release.json。
...
## 2026-09-22 · 故事推演展示发布验收

四位人物在进入推演后才加载，服饰与头像分别区分宝玉、黛玉、宝钗、熙凤；动作沿既有路线执行，新增持书、摆臂、交谈和到场持盏。进入推演默认临场镜头，支持自动跟拍；问安、茶叙与剧情入口直接连接真实存档操作。服饰、动作和对白属于艺术演绎及虚构推演。

本地102项单元／API、7项浏览器回归及细化后3项人物专项、38项推演、21项参与互动、24项剧情漫画检查实际通过；构建、lint和10,968项资料校验通过。线上再次通过桌面／390px触摸正式运行、21项参与互动与24项剧情漫画；新入口实走完成四个模型加载、黛玉问安、三人赴约品茗及刷新后的手机沉浸操作。线上截图已实际打开核对，未发生页面或资源错误。

上传包912份文件、50,247,269字节；31张图片按固定公开提交和哈希在构建时恢复。632份公开资源及当前前端构建共637份容器运行文件全部解码哈希匹配，另有14个关键HTTPS URL核对，包含四份人物模型及溯源清单。18项服务变量与原画册6份文件保持，未新增付费模型调用。线上检查使用独立直连浏览器、HTTP/1.1与正常TLS；未修改系统代理，手机检查为模拟设备。
