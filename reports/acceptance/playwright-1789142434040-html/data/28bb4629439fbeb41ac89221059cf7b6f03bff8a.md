...
- generic [ref=e3]:
  ...
  - main [ref=e41]:
    - generic [ref=e43]:
      ...
      - button "定位大观园入口" [ref=e50] [cursor=pointer]:
        - generic [ref=e51]: "01"
        - text: 大观园入口
      - button "定位蘅芜苑" [ref=e54] [cursor=pointer]:
        - generic [ref=e55]: "05"
        - text: 蘅芜苑
      - button "定位秋爽斋" [ref=e57] [cursor=pointer]:
        - generic [ref=e58]: "06"
        - text: 秋爽斋
      - button "定位藕香榭" [ref=e60] [cursor=pointer]:
        - generic [ref=e61]: "08"
        - text: 藕香榭
      - button "定位大观楼" [ref=e63] [cursor=pointer]:
        - generic [ref=e64]: "13"
        - text: 大观楼
      - button "定位栊翠庵" [ref=e66] [cursor=pointer]:
        - generic [ref=e67]: "14"
        - text: 栊翠庵
      - button "定位暖香坞" [ref=e69] [cursor=pointer]:
        - generic [ref=e70]: "15"
        - text: 暖香坞
    - generic:
      - button "展开索引" [ref=e71] [cursor=pointer]
      - generic:
        - heading "一园山水" [level=1]
        - paragraph: 沿一湾曲水，走入红楼深处。
    - generic "园林光照" [ref=e75]:
      - button "晨光" [pressed] [ref=e76] [cursor=pointer]
      - button "月夜" [ref=e83] [cursor=pointer]
    - generic [ref=e86]:
      - button "回到全园" [ref=e87] [cursor=pointer]
      - button "切换地点名签" [pressed] [ref=e91] [cursor=pointer]
      - button "俯瞰全园布局" [ref=e96] [cursor=pointer]
      - generic [ref=e100]: 俯瞰
    - generic:
      - generic [ref=e101]:
        - generic [ref=e102]:
          - generic [ref=e103]: 园图
          - button "俯瞰" [ref=e104] [cursor=pointer]
        - img "大观园小地图" [ref=e110]:
          - button "地图选择大观园入口" [ref=e176] [cursor=pointer]
          - button "地图选择曲径通幽" [ref=e179] [cursor=pointer]
          - button "地图选择潇湘馆" [ref=e182] [cursor=pointer]
          - button "地图选择怡红院" [ref=e185] [cursor=pointer]
          - button "地图选择蘅芜苑" [ref=e188] [cursor=pointer]
          - button "地图选择秋爽斋" [ref=e191] [cursor=pointer]
          - button "地图选择稻香村" [ref=e194] [cursor=pointer]
          - button "地图选择藕香榭" [ref=e197] [cursor=pointer]
          - button "地图选择滴翠亭" [ref=e200] [cursor=pointer]
          - button "地图选择芦雪庵" [ref=e203] [cursor=pointer]
          - button "地图选择凸碧山庄" [ref=e206] [cursor=pointer]
          - button "地图选择凹晶溪馆" [ref=e209] [cursor=pointer]
          - button "地图选择大观楼" [ref=e212] [cursor=pointer]
          - button "地图选择栊翠庵" [ref=e215] [cursor=pointer]
          - button "地图选择暖香坞" [ref=e218] [cursor=pointer]
      - generic:
        - generic: 精细园景
  ...
  - generic [ref=e221]:
    - generic [ref=e225]:
      - strong [ref=e226]: 红楼拾遗
      - generic [ref=e227]: 22 段有出处的故事
    - contentinfo [ref=e228]:
      - generic [ref=e234]:
        - generic [ref=e235]: 选一条路，慢慢走
        - combobox "选一条路，慢慢走" [ref=e236] [cursor=pointer]:
          - option "园林初览" [selected]
          - option "诗社与雅集"
          - option "刘姥姥游园"
      - generic [ref=e237]:
        - strong [ref=e238]: 从曲径到四处院落，读一遍园林的性情。
        - generic [ref=e239]: 7 处停留 · 策划路线，非原著完整行迹
      - button "开始游园" [ref=e241] [cursor=pointer]
```
