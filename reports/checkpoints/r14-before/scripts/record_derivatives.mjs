...
for(const a of assets.filter(a=>a.status==='approved')){
 ...
 if(a.assetId==='forest_ground_06'){
  ...
  a.modifications='Two complete native 784/816 triangle variants centered at their roots without nonuniform scaling. Source UVs and 512px RGBA texture retained. At most64 instances on desktop,28 mobile, prioritized by projected visibility, selected courtyard and camera distance, refreshing for camera translation and rotation. The selected courtyard is included up to200m; low-quality overview defers the fern models until a place is selected; other plants render within46/29m and scale out over the last8m. The bamboo court has112 grouped fern placements scaled1.2–1.9, under the unchanged instance budget. Placements are interpretive, not botanical evidence.';
